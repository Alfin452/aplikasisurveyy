...
<div class="p-6 bg-white rounded-xl shadow-md" x-data="{ openDeleteModal: false, deleteUrl: '', deleteItemName: '' }">
    ...
    {{-- Header Halaman Premium dengan Breadcrumbs --}}
                ...
                <nav class="text-sm mb-2 font-medium text-gray-500" aria-label="Breadcrumb">
                    <ol class="list-none p-0 inline-flex">
                        <li class="flex items-center">
                            <a href="{{ route('superadmin.dashboard') }}" class="hover:text-gray-700">Dashboard</a>
                            <svg class="fill-current w-3 h-3 mx-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                <path d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569 9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z" />
                            </svg>
                        </li>
                        <li class="flex items-center">
                            <a href="{{ route('surveys.index') }}" class="hover:text-gray-700">Manajemen Survei</a>
                            <svg class="fill-current w-3 h-3 mx-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                <path d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569 9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z" />
                            </svg>
                        </li>
                        <li class="flex items-center">
                            <span class="text-gray-700">Template Survei</span>
                        </li>
                    </ol>
                </nav>
                <div class="flex items-center gap-4">
                    <div class="flex-shrink-0 bg-gray-500 text-white p-3 rounded-lg shadow-md">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Simpan survei yang sering digunakan untuk efisiensi di masa depan.</p>
                    </div>
                </div>
            </div>
            <a href="{{ route('surveys.index') }}" class="mt-4 md:mt-0 bg-white text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-100 transition flex items-center space-x-2 border border-gray-300 self-start md:self-end">
    ...
    {{-- Panel Aksi dengan Desain Premium Baru --}}
    <div class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-6 border border-indigo-200 relative overflow-hidden">
        <div class="relative z-10">
            <h2 class="text-xl font-bold text-indigo-800 mb-2">Jadikan Survei sebagai Template</h2>
            <p class="text-gray-600 mb-6 text-sm max-w-2xl">Pilih salah satu survei yang sudah ada untuk menyimpannya sebagai cetakan yang bisa digunakan kembali kapan pun, lengkap dengan semua pertanyaannya.</p>
            <form action="{{ route('templates.store') }}" method="POST">
                ...
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <button type="submit" class="bg-indigo-600 text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-indigo-700 transition shadow-lg hover:shadow-indigo-300 flex items-center space-x-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="absolute -right-16 -bottom-16 opacity-10">
            <svg width="250" height="250" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-indigo-500">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-xl hover:border-indigo-300 hover:-translate-y-1 transition-all duration-300 flex flex-col group">
            <div class="p-5 flex-grow">
                <div class="flex items-start justify-between">
                    <h3 class="font-bold text-lg text-gray-800 mb-2 group-hover:text-indigo-600 transition-colors duration-300">{{ $template->title }}</h3>
                    <div class="text-gray-300 group-hover:text-indigo-500 transition-colors duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="bg-gray-50 p-3 flex items-center justify-between border-t">
                ...
                <a href="{{ route('surveys.create_from_template', $template->id) }}" class="bg-green-500 text-white px-4 py-1.5 rounded-lg text-xs font-semibold hover:bg-green-600 transition shadow-md hover:shadow-lg hover:-translate-y-0.5 transform flex items-center space-x-1.5">
