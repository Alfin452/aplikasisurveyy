...
<div class="py-6 sm:py-10 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <p class="mt-2 text-gray-600">Menampilkan hasil khusus untuk unit kerja Anda.</p>
            ...
            <div class="flex items-center space-x-4">
                <div class="flex items-center text-sm text-gray-500">
                    ...
                    <span class="ml-1">Responden dari Unit Anda</span>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-8">
                        ...
                        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                            <table class="min-w-full divide-y divide-gray-300">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    ...
                                    // DIPERBAIKI: Gunakan method sum() dari Collection, bukan array_sum() dari PHP
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 text-center">
                <p class="text-gray-600">Belum ada data jawaban dari unit kerja Anda untuk survei ini.</p>
            </div>
            @endforelse
        </div>
