...
<div class="p-6 bg-white rounded-xl shadow-md">
            ...
            <div>
                <nav class="text-sm mb-2 font-medium text-gray-500" aria-label="Breadcrumb">
                    <ol class="list-none p-0 inline-flex">
                        ...
                        <li class="flex items-center"><span class="text-gray-700">Edit Pertanyaan</span></li>
                    </ol>
                </nav>
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Perbarui detail untuk pertanyaan ini.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <form action="{{ route('surveys.questions.update', [$survey, $question]) }}" method="POST">
        @method('PUT')
        @include('unit_kerja_admin.surveys.questions._form', ['question' => $question])
